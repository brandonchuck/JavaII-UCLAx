...
public class DepartmentManager {
    ...
    public DepartmentManager(String empNo, String deptNo, String fromDate, String toDate){
    ...
    public static ObservableList<DepartmentManager> getDeptManagers() {

        // Observable array list for storing employees from DB
        ObservableList<DepartmentManager> ret_val = FXCollections.observableArrayList();
        ...
        try {
            ...
            PreparedStatement stmt = conn.prepareStatement("select * from dept_manager limit 50");
            ...
            while (rs != null && rs.next()) {
                ...
                ret_val.add(new DepartmentManager(emp_no, dept_no, fromDate, toDate));
            }
